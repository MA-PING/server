...
import org.maping.maping.common.utills.gemini.dto.GeminiResponseDTO;
...
public class GEMINIUtils {
    ...
    public String getAiStat(String ocid) {
        ...
        String text = "기본정보 : " + basic.toString() + ", 스탯 : " + stat.toString() + "\n" +
    ...
    public String getAIEquipment(String ocid) {
        CharacterBasicDTO basic = nexonUtils.getCharacterBasic(ocid);
        CharacterItemEquipmentDTO itemEquipment = nexonUtils.getCharacterItemEquip(ocid);
        log.info("itemEquipment: {}", itemEquipment);

        String text = "기본정보 : " + basic.toString() + ", 장비 : " + itemEquipment.toString() + "\n" +
    ...
    public String getAiUnion(String ocid) {
        ...
        String text = "기본정보 : " + basic.toString() + ", 유니온 : " + union.toString() + "\n" +
